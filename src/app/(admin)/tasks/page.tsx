...
import { Plus, List, LayoutGrid, ChevronLeft, ChevronRight, X, Loader2 } from 'lucide-react'

export default function TasksPage() {
    const { tasks, addTask, deleteTask, updateStatus, fetchTasks, isLoading } = useTaskStore()
